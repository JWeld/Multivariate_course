...
dend2 %>% set("labels_color") %>% set("branches_lwd") %>%  set("branches_k_color", k = 4) %>% plot(main = "Euclidean and average")
#
...
dend3 <- dune %>% # data
  ...
  as.dendrogram # Turn the object into a dendrogram.
dend3 %>% set("labels_color") %>% set("branches_lwd") %>%  set("branches_k_color", k = 4) %>% plot(main = "Euclidean and Ward*s")
...
dend4 <- dune.dist %>% # data (Bray-Curtis)
  hclust(method = "aver") %>% # Hierarchical clustering, average method
  as.dendrogram # Turn the object into a dendrogram.
dend4 %>% set("labels_color") %>% set("branches_lwd") %>%  set("branches_k_color", k = 4) %>% plot(main = "Bray-Curtis, Average")
#
...
dend5 <- dune.dist %>% # data (Bray-Curtis)
  hclust(method = "ward.D") %>% # Hierarchical clustering, Ward’s method
  as.dendrogram # Turn the object into a dendrogram.
dend5 %>% set("labels_color") %>% set("branches_lwd") %>%  set("branches_k_color", k = 4) %>% plot(main = "Bray-Curtis, Ward’s")

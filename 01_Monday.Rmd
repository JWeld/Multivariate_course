...
#### 5.2 Can you see an edge effect (a mathematical artifact that compresses the samples at one or both ends of a gradient)?

#### 5.3 Can you see an arch effect (if there is an arch, samples will appear in an arch in the same order as in the input data file)?
...
6.1 If you found artifacts in the CA in question 5, did the detrending remove them?

...
### [Excercise 8: Effects from increased variation.]{style="color:cornflowerblue"}
...
head(gf)#the values in column CA2 are the cummulative goodness of fit values over the two axes

...
#### <span style="color:Red">Write your answers to the questions and any other comments in the Answers.Rmd file </span>
...
### <span style="color:cornflowerblue">Question 2: Simple exercise for illustrating effects of different distance metrics. Should not be based on ordination or classification.</span>

#### <span style="color:forestgreen">Simple exercise for illustrating effects of different distance metrics. Should not be based on ordination or classification.</span>
...
### <span style="color:cornflowerblue">Question 8:	Non Metric Multidimensional Scaling </span>
...
### <span style="color:cornflowerblue">Question 9:	PCoA </span>

#### <span style="color:forestgreen"> PCoA </span>
<br>
```{r}
#To follow, Martyn
```
...
### <span style="color:cornflowerblue">Question 12:	Use the results from the CCA ordination in exercise 13 to look at and interpret the variance inflation factor, and to look for warnings about outliers in the explanatory data!   </span>
...
### <span style="color:cornflowerblue">Question 24:	Procustes rotation and Co-correspondence analysis  </span>
...
### <span style="color:cornflowerblue">Question 25 : Classification </span>
...
***
#Q26
### <span style="color:cornflowerblue">Question 26: Classification 2 </span>

#### <span style="color:forestgreen">Classification 2 </span>
...
#### <span style="color:forestgreen">PRC </span>
...
### <span style="color:cornflowerblue">Question 28: ANOSIM & SIMPER</span>
...
### <span style="color:cornflowerblue">Question 29: Diagnostic species for a priori defined groups </span>
...
In this exercise we will investigate if any particular species are indicative for the four different management types.
...
### <span style="color:cornflowerblue">Question 30: Molecular Data</span>
...
### <span style="color:cornflowerblue">Question 31: PLS </span>
...
#The results below show that 'Tot-N_TNb' and 'Mn' are the two most important positive predictors of 'Antal arter'.  You could run the code #barplot(head(coefficients, 5)) to see that at the other end of the scale for negative predictors.
summary(pls.fit2)
plot(pls.fit)

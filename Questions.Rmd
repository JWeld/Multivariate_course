...
n.tests <- ncol (dune.env)  # number of tests equals # of variables which are being selected
pval.adj <- p.adjust (FS2$pval, method = 'holm', n = n.tests)
FS2$pval.adj <- pval.adj
FS2

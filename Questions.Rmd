...
#### <span style="color:forestgreen"> Examine the p-values to explore which explanatory variables actually give a significant result.Questions: Which explanatory variables are most important to explain the response variable (Biovolume)? Are there any obvious outliers in the dataset? Does the data seemed to be in need of a transformation? </span>

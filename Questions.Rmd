...
inertia values (also, it produces only four axes, i.e. four eigenvalues). See also the comment in the 
code for the last question. However, you may get total inertia by applying correspondence 
analysis (CA) on your data.
...
#### <span style="color:forestgreen"> Look at and interpret the inflation factors for each environmental variable! Are there any warning for extreme values? </span>

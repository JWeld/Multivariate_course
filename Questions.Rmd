...
### <span style="color:cornflowerblue">Question 7:	Effects from increased variation. Add one new sample to the data, then add a cover of 9 for the existing species Chenopodium album "Che_alb" in the new sample. Make a new DCA-ordination. <br> Next, remove the Che alb = 9, and add instead a cover of 5 for the exisiting species Leo_aut and make a new DCA. </span>
...
#View(data.pls)
library(pls)
#Change Species_count to your choice of response variable(s)
pls.fit <- plsr(Species_count ~ ., data = data.pls[c(9:35)], scale = TRUE, validation = "CV")
...
best.dims 
# Rerun the model
pls.fit2 <-  plsr(Species_count ~ ., data = data.pls[c(6:35)], ncomp = best.dims)

...
#### [6.1: What happens with the eigenvalues and ordination diagram?]{style="color:forestgreen"}
...
#### [7.1 What happens with the eigenvalues and ordination after adding Chealbu and after adding Juncbufo?]{style="color:forestgreen"}

#### [7.2 Why did we choose to add these two species in the new sample?]{style="color:forestgreen"}
...
#### [8.1 How similar are the ordination plots based on the four distance matrices?(remember question 2!)]{style="color:forestgreen"}

#### [8.2 Why are some plots more similar than others?]{style="color:forestgreen"}

#### [8.3 Which PCoA plot is most similar to the output from a PCA?]{style="color:forestgreen"}

#### [8.4 Which PCoA plot is most similar to the output from a CA?]{style="color:forestgreen"}
...
#### [9.1 Compare the vegan default NMDS to the results of a CA and a DCA.]{style="color:forestgreen"}
...
#### [10.1 Is there a pattern in the distribution of missing values that may lead to the omission of a species or a sample?]{style="color:forestgreen"}

#### [10.2 Would you say that the original Dune Meadow data set is OK for further analyses? Motivate your answer!]{style="color:forestgreen"}
...
Sometimes loaded packages in R can conflict with another package. This can happen 
after an update of one or more packages. Here the current version of VIM
conflicts with some functions in Vegan that we use later, so we need to
unload VIM now that we have finished using it.
...
#### [11.3 Taking the nature of the data into account, which method should be used?]{style="color:forestgreen"}
...
#### [14.2 What does the display = "cn" in the last plots mean?]{style="color:forestgreen"}
...
#### [16.1 Explain the results of the permutations! Compare the results in exercises 16 and 17!]{style="color:forestgreen"}
...
#### [18.2 We may expect that Management and Manure are correlated, check visually by making a boxplot of Manure vs Management type using the R code: boxplot(Manure\~Management, data = dune.env.original). What does the result tell you?]{style="color:forestgreen"}
...
#### [20.1 Which Ellenberg values are most important for the distribution of the species?]{style="color:forestgreen"}

#### [20.2 What do the different axes represent in terms of environmental gradients?]{style="color:forestgreen"}
...
#### [21.1 Perform the analyses and interpret the results - how much of the total variation (% of All) is explained by: - uniquely by Management (effect of Soil removed), - uniquely by Soil (effect of Management removed), - jointly by Soil and Management (the interaction) - Not by Soil or Management?]{style="color:forestgreen"}
...
#### [22.1 Is there a significant change in species composition over time?]{style="color:forestgreen"}

#### [22.2 What is the effect of defining Plots as co-factors?]{style="color:forestgreen"}
...
#### [23.1 Did the treatment have an effect?]{style="color:forestgreen"}

#### [23.2 What was permuted?]{style="color:forestgreen"}
...
In this exercise you will use a third data set from the dune meadow. 
The new data is insect abundance at the different plots.


#### [Questions:]{style="color:forestgreen"}

#### [24.1 How similar is the arrangement of sites in ordination space based on plant and insect data?]{style="color:forestgreen"}

#### [24.2 Do the three analyses (Procrustes, Co-Correspondence and Mantel) indicate similar ordinations of sites based on plant vs. insect data?]{style="color:forestgreen"}
...
#### [25.1 How many clusters seem to exist in the Dune data set?]{style="color:forestgreen"}

#### [25.2 Is a 3- or 4-cluster solution a better match to the management type in the dune.env dataset?]{style="color:forestgreen"}

#### [25.3 Do the two approaches to hierarchical clustering reveal similar patterns in the Dune data set?]{style="color:forestgreen"}

#### [25.4 Interpret the Hopkins statistic for the Dune data set.]{style="color:forestgreen"}
...
#### [26.1 Based on a visual analysis, which dimensions provide the best separation between iris species?]{style="color:forestgreen"}

#### [26.2 Are your insights from the visual analysis confirmed by the partition tree analysis?]{style="color:forestgreen"}

#### [26.3 Does the partition tree provide a perfect species identification or are there misclassifications?]{style="color:forestgreen"}
...
#### [27.1 Was there an effect of dose over time on the invertebrate community?]{style="color:forestgreen"}

#### [27.2 Which species were most affected, i.e changed most under the highest dose compared to the control ?]{style="color:forestgreen"}
...
#### [28.1 What do the results from anosim and adonis tell you?]{style="color:forestgreen"}

#### [28.2 Give one other example of predefined groups that could be used as the grouping variable(s)!]{style="color:forestgreen"}
...
#### [29.1 How well does the algorithm distinguish between the species?]{style="color:forestgreen"}

#### [29.2 Here our groups are pre-defined (species). Would it be OK to use one of the clustering methods to find groups before running the DFA?]{style="color:forestgreen"}
...
#### [30.1 How do the ordinations produced compare to a distance based ordination (for example an NMDS) of the same species data?]{style="color:forestgreen"}
...
#### [31.1 Do the correlations in the plot make sense ecologically?]{style="color:forestgreen"}
...
#### [32.1 Which explanatory variables are most important to explain the response variable (Biovolume)?]{style="color:forestgreen"}

#### [32.2 Are there any obvious outliers in the dataset?]{style="color:forestgreen"}

#### [32.3 Does the data seem to be in need of a transformation?]{style="color:forestgreen"}

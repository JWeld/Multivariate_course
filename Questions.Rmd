...
### <span style="color:cornflowerblue">Question 7:	Effects from increased variation. Add one new sample to the data, then add a cover of 9 for the existing species Chenopodium album "Chealbu" in the new sample. Make a new DCA-ordination. <br> Next, remove the Che alb = 9, and add instead a cover of 5 for the exisiting species Juncbufo and make a new DCA. </span>

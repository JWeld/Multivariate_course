...
(i)  How similar is the arrangement of sites in ordination space based on plant and insect data?
(ii) Do the three analyses (Procrustes, Co-Correspondence and Mantel) indicate similar ordinations of sites based on plant vs. insect data?
 </span>
...
(iii) Do the two approaches to hierarchical clustering reveal similar patterns in the Dune data set?
...
#### <span style="color:forestgreen"> Examine the p-values to explore which explanatory variables actually give a significant result.
(i) Which explanatory variables are most important to explain the response variable (Biovolume)?
(ii) Are there any obvious outliers in the dataset?
(iii) Does the data seemed to be in need of a transformation? </span>

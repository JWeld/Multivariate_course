...
pls.fit <- plsr(Biovolume_exGonyo ~ ., data = data.pls[c(9:34)], scale = TRUE,
...
best.dims 
# Rerun the model
pls.fit2 <-  plsr(Biovolume_exGonyo ~ ., data = data.pls[c(9:34)], ncomp = best.dims)
...
plot(pls.fit2, "loadings", comps = 1:2, legendpos = "topleft", xlab = "nm")
abline(h = 0)
...
plot(pls.fit2, ncomp = 2, asp = 1, line = TRUE)

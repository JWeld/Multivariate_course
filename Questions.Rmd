...
DCA-ordination. Next, remove the Chealbu = 9, and add instead a cover of
5 for the exisiting species Juncbufo and make a new DCA.
...
We can also try testing for outliers in the data. Be aware that this is
only indicative, and you still need to exercise your judgement about
what should be excluded as an outlier!
...
```{r}
#VIM package loaded earlier conflicts with SIMPER

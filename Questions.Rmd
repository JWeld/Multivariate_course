...
Sometimes loaded packages in R can conflict with one another, sometimes
after an update of one of other package. Here the current version of VIM
conflicts with some functions in Vegan that we use later, so we need to
unload VIM now we have finished with it.

...
#### [28.2 Give one other example of predefined groups that could be uses as the grouping variable(s)!]{style="color:forestgreen"}
...
#### [32.3 Does the data seemed to be in need of a transformation?]{style="color:forestgreen"}

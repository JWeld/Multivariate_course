...
#The results below show that 'Total_P' and 'Turbulance' are the two most important positive predictors of biovolume.
#You can run the following to see the other end of the scale for negative predictors.
barplot(head(coefficients, 3))
#Here we see that Secchi depth and pH ares the most important negative predictors.
summary(pls.fit2)
